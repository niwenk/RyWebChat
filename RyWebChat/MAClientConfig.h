...
#ifndef MAClientConfig_h
#define MAClientConfig_h

#define MACLIENTSERVERADDR @"http://www.elitecrm.com/webchat" //服务器地址
#define MACLIENTWSADDR @"ws://www.elitecrm.com/webchat" //webSocket地址
